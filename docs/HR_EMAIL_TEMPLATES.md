# NB Media — HR Email Templates (Source of Truth)

> Verbatim from the HR-provided "EMAIL TEMPLATES" document.
> All hiring-flow emails MUST use this wording, not the generic modal defaults.
> Yellow-highlighted tokens in the original doc are merge fields — kept here in `{{double-braces}}`.

---

## 1. Candidate Rejection E-mail
...
## 2. Portfolio Required — "{{JobRole}}" role at NB Media
...
We kindly request that you submit your portfolio by **{{Date}}**.
...
## 3. Work Sample Required — "Script Writer" role at NB Media
...
## 4. Work Sample Required — "Video Editor" role at NB Media
...
Script: {{WorkAssignmentVideoEditorScript}}
...
## 5. Work Sample Required — "Graphic Designer" role at NB Media
...
Script: {{WorkAssignmentGraphicDesignerScript}}
...
## 6. Candidate Selection E-Mail (For Technical Round)
...
## 8. Congratulations on Your Selection — Documents Request
...
We are delighted to extend an offer of employment to you for the position of **{{JobRole}}** at **NB Media** commencing on **{{JoiningDate}}**. We were impressed with your qualifications, experience, and the positive impression you left during the interview process.

Please review the enclosed Job offer letter, which outlines the terms and conditions of your employment with NB-Media, and provide your response by **{{ResponseDeadline}}**. We believe that your skills and expertise will be a valuable addition to our team, and we are excited about the prospect of working together.
...
## 10. New Joiner — Team Announcement (Internal)
...
{{FirstName}} hails from {{HomeCity}} and has worked as a {{PriorRole}}. {{Pronoun}} has joined us as a **"{{JobRole}}"** and we are highly enthusiastic about witnessing {{themPronoun}} apply {{theirPronoun}} experience and educational background to contribute to the growth of our business.

{{FirstName}} will report to **{{ManagerName}}** and collaborate closely with {{managerPronoun}}. {{FirstName}} shall be working from the **{{OfficeLocation}} office** and you can reach {{themPronoun}} at **{{Phone}}** and **{{WorkEmail}}** so be sure to drop by and say hello and take a moment to introduce yourselves to {{themPronoun}}. A warm and friendly welcome can go a long way in making someone feel at home.
...
## 11. Probation Completion / Confirmation
...
- Always sign as **HR Department / NB-Media** (NOT "NB Media Hiring Team" as the modal defaults use)
- Greeting uses **"Dear {{CandidateName}},"** (NOT "Hi {{firstName}},") for all candidate-facing emails
- Opening line is **"Greetings from NB Media!"** for nearly every candidate-facing template
- Closing is **"Warms Regards,"** (note: the doc uses "Warms" not "Warm" — preserved verbatim)
