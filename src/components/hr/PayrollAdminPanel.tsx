...
import {
  Play, CheckCircle2, Clock, Plus, X,
  Lock as LockIcon, Banknote, RotateCcw,
} from "lucide-react";
      ...
      {adminTab === "runs" ? (
        ...
        <div className="p-5">
          <p className="text-[13px] text-slate-500">
            Salary structures live on each employee&apos;s profile. Click &quot;Assign Structure&quot; above to set
            one for an employee, or open <strong>People → Employee</strong> for the full editor with PF/tax-regime.
          </p>
        </div>
      )}
